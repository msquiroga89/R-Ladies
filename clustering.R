########### R-Ladies Clustering #######################
# Video: https://www.youtube.com/watch?v=HRnuJ-0UMZY


A <- read.csv("https://raw.githubusercontent.com/diagiraldo/RLadies_bta_2021/master/datos/neuropsycho_data.csv")
...
k <- 2 # primero se tienen que definir los grupos en los que quiero dividir los datos
k2res <- kmeans(B, k)
str(k2res)
